...
class MinuteTemp extends Model
{
    ...
    public function project(){
        return $this->hasOne('Project',"project_id","project_id")->field('project_id,project_name');
    }
    ...
    public function attachments(){
        return $this->hasMany('Attachment', 'related_id', 'minute_id')->where('attachment_type', 'minute')->field('attachment_id, source_name, uploader_id, file_size, save_path, upload_time');
    }
}